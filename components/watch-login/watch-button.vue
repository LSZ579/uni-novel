	...
	export default{
		props:{
			...
			bgColor:{
				//按钮背景颜色
				type: String,
				default: "linear-gradient(to right, rgba(0, 174, 177, 1), rgba(0, 198, 145, 0.8))",
			},
			fontColor:{
				//按钮字体颜色
				type: String,
...
<style>
	...
	.dlbutton {
		...
		width:601upx;
		height:100upx;
		background:linear-gradient(to right, rgba(0, 174, 177, 0.7), rgba(0, 198, 145, 0.6));
	...
	.dlbutton_loading {
		...
		width:100upx;
		height:100upx;
		background:linear-gradient(to right, rgba(85, 255, 127, 0.7), rgba(0,0,0,0.6));
		box-shadow:0upx 0upx 13upx 0upx rgba(164,217,228,0.4);
		border-radius:2.5rem;
		margin-top: 0upx;
	}
